...
function formatGameDocument(id: string, data: any): Game {
  return {
    ...
    thumbnail: data.thumbnail || (id === 'chor-police-dakat-babu' ? '/assets/games/chor-police-dakat-babu/Banner.png' : id === 'chakranto' ? '/assets/games/chakranto/Banner.png' : 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=800&auto=format&fit=crop'),
    banner: data.banner || (id === 'chor-police-dakat-babu' ? '/assets/games/chor-police-dakat-babu/Banner.png' : id === 'chakranto' ? '/assets/games/chakranto/Banner.png' : 'https://images.unsplash.com/photo-1579783902614-a3fb3927b675?q=80&w=1600&auto=format&fit=crop'),
    coverArt: data.coverArt || (id === 'chor-police-dakat-babu' ? '/assets/games/chor-police-dakat-babu/Banner.png' : id === 'chakranto' ? '/assets/games/chakranto/Banner.png' : undefined),
